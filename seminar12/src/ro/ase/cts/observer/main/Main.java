...
public class Main {
    public static void main(String[] args) {
        ...
        Calator calator2 = new CalatorAbonat("Andrei");
        Calator calator3 = new CalatorAbonat("Matei");
        Calator calator4 = new CalatorAbonat("Vio");

        MijlocDeTransport autobuz = new Autobuz("135");
        ...
        autobuz.dezabonareCalator(calator1);
